...
Ite tykkään Chromesta enemmän kuin Firefoxista niin tehdääs sen asennuksesta ja käynnissäolosta Salt komento.

Ensiksi tein uuden kansion Saltin alle.

	$ sudo mkdir chrome 
	teemuk@teemu-yoga:/srv/salt$ ls
	apache  chrome  sshd  sshd_config
	
Tässä vielä kuva init.sls tiedostosta:![init.sls](chrome.png)
