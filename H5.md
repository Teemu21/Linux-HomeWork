...
├──────────────────────────────┼──────────────────────────────┼──────────────────────────────┼──────────────────────────────┤
│    \  /       Partly cloudy  │  _`/"".-.     Light rain sho…│    \  /       Partly cloudy  │     \   /     Sunny          │
│  _ /"".-.     +7(5) °C       │   ,\_(   ).   +9(6) °C       │  _ /"".-.     +10(8) °C      │      .-.      +5(2) °C       │
│    \_(   ).   ↗ 10-12 km/h   │    /(___(__)  ↗ 17-22 km/h   │    \_(   ).   ↗ 17-22 km/h   │   ― (   ) ―   → 11-23 km/h   │
│    /(___(__)  10 km          │      ‘ ‘ ‘ ‘  10 km          │    /(___(__)  10 km          │      `-’      10 km          │
│               0.0 mm | 0%    │     ‘ ‘ ‘ ‘   0.2 mm | 96%   │               0.0 mm | 0%    │     /   \     0.0 mm | 0%    │
└──────────────────────────────┴──────────────────────────────┴──────────────────────────────┴──────────────────────────────┘
                                                       ┌─────────────┐                                                       
┌──────────────────────────────┬───────────────────────┤  Mon 02 May ├───────────────────────┬──────────────────────────────┐
│            Morning           │             Noon      └──────┬──────┘     Evening           │             Night            │
...
│      .--.     +8(4) °C       │  _ /"".-.     +10(6) °C      │  _ /"".-.     +8(4) °C       │  _ /"".-.     +6(2) °C       │
│   .-(    ).   ↗ 22-30 km/h   │    \_(   ).   ↗ 27-31 km/h   │    \_(   ).   ↗ 27-32 km/h   │    \_(   ).   → 18-29 km/h   │
...
│  _ /"".-.     +5(1) °C       │      .--.     +7(3) °C       │      .--.     +6(3) °C       │      .--.     +4(0) °C       │
│    \_(   ).   → 25-28 km/h   │   .-(    ).   ↘ 23-27 km/h   │   .-(    ).   ↘ 18-21 km/h   │   .-(    ).   ↘ 16-24 km/h   │
